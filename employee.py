...
class employeeClass:
    def __init__(self,root):
        ...
        #===options
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchBy,values=("Select","Email","Name","eid","Contact"),state='readonly',justify=CENTER,font=("goudy old style",15)) 
        ...
        #===title===
        title=Label(self.root,text="Employee Details",font=("Georgia",15,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000)
        ...
        btn_add=Button(self.root,text="Save",command=self.add,font=("Georgia",12,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("Georgia",12,"bold"),bg="#4caf50",fg="white",cursor="hand2").place(x=620,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("Georgia",12,"bold"),bg="#f44336",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("Georgia",12,"bold"),bg="#607d8b",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=28)
    ...
    def add(self):
        ...
        try:
            ...
            if self.var_emp_id.get()=="": #or self.var_name.get()=="":
                messagebox.showerror("Error","Employee ID must be requrired",parent=self.root)
            else:
    ...
    def get_data(self,ev):
         ...
         self.var_emp_id.set(row[0])    #index starting from zero
